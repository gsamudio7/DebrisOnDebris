...
debrisData[fragLabel %in% c(">= 1000",">= 10000"),
           .(`Fragment Size`=fragLabel,
             Median=median(Pc_min) %>% formatC(format="e",digits=2),
             Mean=mean(Pc_min) %>% formatC(format="e",digits=2),
             `50% Quantile`=quantile(Pc_min,.5) %>% formatC(format="e",digits=2))
             ,by=fragLabel][,!"fragLabel"] %>% 
