...
How many events have $\text{Collision Probability} = 0$ when within one day to TCA?
...
- At five days to TCA the number of new concern events drastically increases.
- We will only have visibility of about $50%$ of concern events at five days to TCA.
